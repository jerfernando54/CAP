             ...
             )
{
    ...
    ts0             = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 32);
    tx              = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 32);
    tt              = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 32);
    tvcall_compiler = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 32);
    tvput_compiler  = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 32);
    tvcall_mkl      = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 32);
    tvput_mkl       = (tfloat*)_mm_malloc( nopt * sizeof(tfloat), 32);
